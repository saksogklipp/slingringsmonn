    ...
    <section>
      ...
      <article class="card" data-testid="product-card-${t.id}">
        ...
        <div class="card-content">
          ...
          <button class="primary" data-action="add-to-cart" data-product-id="${t.id}" data-testid="add-${t.id}">
            Add to Cart
          </button>
        </div>
      </article>
